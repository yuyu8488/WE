...
public:
	...
	virtual ~LandAndWavesApp() override;
...
{
	mShaders["standardVS"] = d3dUtil::CompileShader(L"Shaders/LandAndWaves.hlsl", nullptr, "VS", "vs_5_0");
	mShaders["opaquePS"] = d3dUtil::CompileShader(L"Shaders/LandAndWaves.hlsl", nullptr, "PS", "ps_5_0");
...
void LandAndWavesApp::BuildLandGeometry()
{
	...
	geo->VertexBufferGPU = d3dUtil::CreateDefaultBuffer(md3dDevice.Get(), mCo mmandList.Get(), vertices.data(), vbByteSize, geo->VertexBufferUploader);
